<template>
	<div class="menu-preview">
		...
		<el-scrollbar wrap-class="scrollbar-wrapper">
			<el-menu :default-active="activeMenu" :default-openeds="[]" :unique-opened="true" :style='{"border":0,"padding":"0","boxShadow":"0 1px 1px #222, 0px 1px 0 #7797ba inset","listStyle":"none","overflow":"hidden","borderRadius":"0 0 4px 4px","background":"linear-gradient(#5d81a6,#43668c)","position":"relative"}' class="el-menu-vertical-demo" default-active="0">
