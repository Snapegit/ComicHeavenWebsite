		...
		<template v-if="showFlag">
			...
			<div :style='{"width":"100%","padding":"10px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='false' :sortable='false' prop="cpicture" width="200" label="留言图片">
						<template slot-scope="scope">
					...
					<el-table-column :resizable='false' :sortable='false' prop="rpicture" width="200" label="回复图片">
						<template slot-scope="scope">
